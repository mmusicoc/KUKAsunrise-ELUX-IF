 ...
 * @see #dispose()
 */
public class DigitalViews extends RoboticsAPIApplication {
	@Inject
	private LBR kiwa;
	...
	{ 
		...
		while (true) {
			...
			{ 
				...
				answer = getApplicationUI().displayModalDialog( ApplicationDialogType.QUESTION, "Iterate port number by 1? ", "No" , "Yes");
				port = port + answer;
			} 
		...
		System.out.println("ServerSocket : InetAddress = " + serverSocket.getInetAddress() + ", Localport = " + serverSocket.getLocalPort());
		System.out.println("Client Socket : InetAddress = " + clientSocket.getInetAddress() + ", Localport = " + clientSocket.getLocalPort()); 

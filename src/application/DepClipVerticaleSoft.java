 ...
 * @see #dispose()
 */
public class DepClipVerticaleSoft extends RoboticsAPIApplication {
	@Inject
	...
	public void run() 
	{
		...
		lbr_iiwa_14_R820_1.moveAsync(ptp(getApplicationData().getFrame("/Prove/AvvPunto3")));
		tool2.move(lin(getApplicationData().getFrame("/Modello2/Avv2")).setCartVelocity(80));

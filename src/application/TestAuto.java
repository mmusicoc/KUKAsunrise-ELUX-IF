 ...
 * @see #dispose()
 */
public class TestAuto extends RoboticsAPIApplication {
	@Inject
	...
	public void run() 
	{
		...
		while(true)
		{
			...
			lbr_iiwa_14_R820_1.moveAsync(ptp(getApplicationData().getFrame("/P1")).setBlendingCart(50));
			lbr_iiwa_14_R820_1.moveAsync(ptp(getApplicationData().getFrame("/P2")));
			lbr_iiwa_14_R820_1.moveAsync(lin(getApplicationData().getFrame("/P3")).setCartVelocity(200).setBlendingCart(50));
			lbr_iiwa_14_R820_1.moveAsync(lin(getApplicationData().getFrame("/P1")).setCartVelocity(200).setBlendingCart(50));		
		}

 ...
 * @see #dispose()
 */
public class Rotazione extends RoboticsAPIApplication {
	@Inject
	...
	{		
		...
		lbr_iiwa_14_R820_1.move(ptp(getApplicationData().getFrame("/PrelievoOR/AllPrel1")).setJointVelocityRel(0.7));
		tool2.move(ptp(getApplicationData().getFrame("/Modello1/Avv1")).setJointVelocityRel(1.0));

 ...
 * @see #dispose()
 */
public class RotazioneSoft extends RoboticsAPIApplication {
	@Inject
	...
	{		
		...
		lbr_iiwa_14_R820_1.moveAsync(ptp(getApplicationData().getFrame("/PrelievoOR/PrelOR")));
		lbr_iiwa_14_R820_1.moveAsync(ptp(getApplicationData().getFrame("/PrelievoOR/AllPrel1")).setBlendingCart(25));
		tool2.move(ptp(getApplicationData().getFrame("/Modello2/Avv1")));

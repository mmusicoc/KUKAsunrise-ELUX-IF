 ...
 * @see #dispose()
 */
public class Tr_Safety extends RoboticsAPIApplication {
	@Inject
	private LBR kiwa;
	...
	public void initialize() {
		...
		kiwa.setHomePosition(getApplicationData().getFrame("/Training"));
		...
		IUserKeyListener listener1 = new IUserKeyListener() {
			...
			public void onKeyEvent(IUserKey key, UserKeyEvent event) {
				...
				if (1 == key.getSlot()) {  						//KEY - SPEED
					promptAns = getApplicationUI().displayModalDialog(ApplicationDialogType.QUESTION, "Set the relative axes speed ", "10%", "25%", "50%", "100%");  
					switch (promptAns) {
					case 0:
						defSpeed = 0.10; 
						break;
